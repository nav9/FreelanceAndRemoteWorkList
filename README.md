...
**IMPORTANT: This lists below were obtained from internet searches, so please use commonsense and due caution when accessing these links that are ordered randomly.**

If you’d like to add to the list or mention which ones are reliable, easy to use, pay well and treat freelancers well, please mention it in the comments so that it’d help others. There are many more such websites. Do share the good ones in the [discussions](https://github.com/nav9/softwareFreelanceAndRemoteJobs/discussions) section.
...
* https://gun.io/  
* https://lemon.io/  
* https://youteam.io/ (strangely [rude and ignorant people](https://youteam.io/blog/offshore-web-development-companies-in-india-do-they-stack-up-against-other-low-cost-options/))  
...
* **Arbitration:** Both the employers and freelancers need to have the assurance that in case of disputes about the quality of work or payment issues, there will be a capable person who will assess the issue and suggest solutions.  
